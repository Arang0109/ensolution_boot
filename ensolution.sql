...
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8 COMMENT='- Stores essential details of companies for measurement service management.\n- Stores client company details: ID, name, address, CEO, business number, and registration date.';
...
INSERT INTO `company` VALUES (2,'현대자동차(주) 울산공장','울산 북구 염포로 700 (양정동)','장재훈','620-86-00010','2024-10-29'),(53,'다모야','부산진구 동평로 291번길 30 (103-403)','유수진','325-17-01564','2024-11-21'),(54,'에쓰-오일 주식회사','서울 마포구 백범로 192 (공덕동)','안와르 에이알 히즈아지','116-81-36743','2024-12-03'),(90,'다모야모야','셀로나','강민수','','2025-01-28');
...
INSERT INTO `schedule` VALUES (245,2,435,'2024-12-11',1),(246,2,440,'2024-12-11',1),(255,2,435,'2024-11-11',1),(256,2,440,'2024-11-11',1),(257,2,435,'2024-10-16',1),(258,3,440,'2024-10-16',1),(259,2,436,'2024-12-27',1),(260,2,441,'2024-12-27',1),(261,1,453,'2024-12-12',1),(262,1,457,'2024-12-12',1),(263,2,562,'2025-01-26',0),(264,2,563,'2025-01-26',0),(265,2,564,'2025-01-26',0),(266,2,566,'2025-01-26',0);
...
INSERT INTO `users` VALUES ('test','$2a$10$v4.f19LRZ/tbNEu6u37fleEL14i.UGVUabfki7c9b8LQCiWaQG2oC','tester01','kmsq321@naver.com');
...
INSERT INTO `workplace` VALUES (10,2,'현대자동차(주) 울산공장','울산 북구 염포로 700 (양정동)','2024-10-29'),(30,53,'다모야 부산지점','부산진구 동평로 291번길 30 (103-403)','2024-11-21'),(31,54,'S-OIL 온산공장','울산 울주군 온산읍 온산로 68','2024-12-03');
...
-- Dump completed on 2025-02-10 19:07:53
